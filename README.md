...
This is very simple app for downloading multiple URLs from meny inputs.
It was originally ment to be just school project but maybe someone finds it useful.
